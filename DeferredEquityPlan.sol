...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now || unlock_time > now, "Too early to execute contract");
        require(distributed_shares <= total_shares || distributed_shares > total_shares, "All shares have already been distributed");
